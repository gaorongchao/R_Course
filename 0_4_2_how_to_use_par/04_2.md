...
默认的为c(5,4,4,2)+0.1，也就是我们上面做的图都是默认值。顺序为下、左、上、右，也就是逆时针的方向。
...
```
## Warning: 'mbcsToSbcs'里转换'瀹炵嚎'出错：<e5>代替了dot
## Warning: 'mbcsToSbcs'里转换'瀹炵嚎'出错：<ae>代替了dot
## Warning: 'mbcsToSbcs'里转换'瀹炵嚎'出错：<9e>代替了dot
## Warning: 'mbcsToSbcs'里转换'瀹炵嚎'出错：<e7>代替了dot
## Warning: 'mbcsToSbcs'里转换'瀹炵嚎'出错：<ba>代替了dot
## Warning: 'mbcsToSbcs'里转换'瀹炵嚎'出错：<bf>代替了dot
## Warning: Unicode字符U+5b9e不带字体度量
## Warning: Unicode字符U+7ebf不带字体度量
```
...
```
## Warning: 'mbcsToSbcs'里转换'铏氱嚎'出错：<e8>代替了dot
## Warning: 'mbcsToSbcs'里转换'铏氱嚎'出错：<99>代替了dot
## Warning: 'mbcsToSbcs'里转换'铏氱嚎'出错：<9a>代替了dot
## Warning: 'mbcsToSbcs'里转换'铏氱嚎'出错：<e7>代替了dot
## Warning: 'mbcsToSbcs'里转换'铏氱嚎'出错：<ba>代替了dot
## Warning: 'mbcsToSbcs'里转换'铏氱嚎'出错：<bf>代替了dot
## Warning: Unicode字符U+865a不带字体度量
## Warning: Unicode字符U+7ebf不带字体度量
```
...
```
## Warning: 'mbcsToSbcs'里转换'鐐圭嚎'出错：<e7>代替了dot
## Warning: 'mbcsToSbcs'里转换'鐐圭嚎'出错：<82>代替了dot
## Warning: 'mbcsToSbcs'里转换'鐐圭嚎'出错：<b9>代替了dot
## Warning: 'mbcsToSbcs'里转换'鐐圭嚎'出错：<e7>代替了dot
## Warning: 'mbcsToSbcs'里转换'鐐圭嚎'出错：<ba>代替了dot
## Warning: 'mbcsToSbcs'里转换'鐐圭嚎'出错：<bf>代替了dot
## Warning: Unicode字符U+70b9不带字体度量
## Warning: Unicode字符U+7ebf不带字体度量
```
...
```
## Warning: 'mbcsToSbcs'里转换'鐐瑰垝绾戼<U+3E66>'出错：<e7>代替了dot
## Warning: 'mbcsToSbcs'里转换'鐐瑰垝绾戼<U+3E66>'出错：<82>代替了dot
## Warning: 'mbcsToSbcs'里转换'鐐瑰垝绾戼<U+3E66>'出错：<b9>代替了dot
## Warning: 'mbcsToSbcs'里转换'鐐瑰垝绾戼<U+3E66>'出错：<e5>代替了dot
## Warning: 'mbcsToSbcs'里转换'鐐瑰垝绾戼<U+3E66>'出错：<88>代替了dot
## Warning: 'mbcsToSbcs'里转换'鐐瑰垝绾戼<U+3E66>'出错：<92>代替了dot
## Warning: 'mbcsToSbcs'里转换'鐐瑰垝绾戼<U+3E66>'出错：<e7>代替了dot
## Warning: 'mbcsToSbcs'里转换'鐐瑰垝绾戼<U+3E66>'出错：<ba>代替了dot
## Warning: 'mbcsToSbcs'里转换'鐐瑰垝绾戼<U+3E66>'出错：<bf>代替了dot
## Warning: Unicode字符U+70b9不带字体度量
## Warning: Unicode字符U+5212不带字体度量
## Warning: Unicode字符U+7ebf不带字体度量
```
...
```
## Warning: 'mbcsToSbcs'里转换'闀垮垝绾戼<U+3E66>'出错：<e9>代替了dot
## Warning: 'mbcsToSbcs'里转换'闀垮垝绾戼<U+3E66>'出错：<95>代替了dot
## Warning: 'mbcsToSbcs'里转换'闀垮垝绾戼<U+3E66>'出错：<bf>代替了dot
## Warning: 'mbcsToSbcs'里转换'闀垮垝绾戼<U+3E66>'出错：<e5>代替了dot
## Warning: 'mbcsToSbcs'里转换'闀垮垝绾戼<U+3E66>'出错：<88>代替了dot
## Warning: 'mbcsToSbcs'里转换'闀垮垝绾戼<U+3E66>'出错：<92>代替了dot
## Warning: 'mbcsToSbcs'里转换'闀垮垝绾戼<U+3E66>'出错：<e7>代替了dot
## Warning: 'mbcsToSbcs'里转换'闀垮垝绾戼<U+3E66>'出错：<ba>代替了dot
## Warning: 'mbcsToSbcs'里转换'闀垮垝绾戼<U+3E66>'出错：<bf>代替了dot
## Warning: Unicode字符U+957f不带字体度量
## Warning: Unicode字符U+5212不带字体度量
## Warning: Unicode字符U+7ebf不带字体度量
```
...
```
## Warning: 'mbcsToSbcs'里转换'鐐归暱鍒掔嚎'出错：<e7>代替了dot
## Warning: 'mbcsToSbcs'里转换'鐐归暱鍒掔嚎'出错：<82>代替了dot
## Warning: 'mbcsToSbcs'里转换'鐐归暱鍒掔嚎'出错：<b9>代替了dot
## Warning: 'mbcsToSbcs'里转换'鐐归暱鍒掔嚎'出错：<e9>代替了dot
## Warning: 'mbcsToSbcs'里转换'鐐归暱鍒掔嚎'出错：<95>代替了dot
## Warning: 'mbcsToSbcs'里转换'鐐归暱鍒掔嚎'出错：<bf>代替了dot
## Warning: 'mbcsToSbcs'里转换'鐐归暱鍒掔嚎'出错：<e5>代替了dot
## Warning: 'mbcsToSbcs'里转换'鐐归暱鍒掔嚎'出错：<88>代替了dot
## Warning: 'mbcsToSbcs'里转换'鐐归暱鍒掔嚎'出错：<92>代替了dot
## Warning: 'mbcsToSbcs'里转换'鐐归暱鍒掔嚎'出错：<e7>代替了dot
## Warning: 'mbcsToSbcs'里转换'鐐归暱鍒掔嚎'出错：<ba>代替了dot
## Warning: 'mbcsToSbcs'里转换'鐐归暱鍒掔嚎'出错：<bf>代替了dot
## Warning: Unicode字符U+70b9不带字体度量
## Warning: Unicode字符U+957f不带字体度量
## Warning: Unicode字符U+5212不带字体度量
